                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="country_name" id="" class="form-control form-control-sm" required="">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <div class="form-gorup">
                            ...
                            <a class="btn btn-light btn-sm shadow-sm" href="{{route('currency.index')}}">Batal</a>
                        </div>
                    </div>
                </div>
            </form>
