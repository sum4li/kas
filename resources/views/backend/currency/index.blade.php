...
<div class="col-lg-12">
    <div class="card shadow-sm mb-4">
        ...
        <div class="card-body">
            <table class="table table-sm table-hover table-bordered" id="currency-table">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Nama</th>
...
$(document).ready(function () {
    ...
    var $table = $('#currency-table').DataTable({
         ...
         columns: [
            ...
            {data: 'country_name', name: 'country_name',width:"70%", orderable : false},
            {data: 'action', name: 'action',width:"2%", orderable : false}
         ]
     });

     $('#currency-table_wrapper > div.toolbar').html('<div class="row">' +
        '<div class="col-lg-10">'+
        ...
        '</div>'+
        '<div class="col-lg-2">'+
            '<a href="{{ route("currency.create") }}" class="btn btn-sm btn-primary shadow-sm float-right" data-toggle="tooltip" title="Tambah Data"><i class="fas fa-plus"></i></a>'+
        '</div>' +
    '</div>');
    ...
    //delete date
    $('#currency-table').on('click','a.delete-data',function(e) {
        e.preventDefault();
